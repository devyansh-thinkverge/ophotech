...
const LinkedInIcon = () => (
  <svg aria-hidden="true" className="size-5" fill="none" viewBox="0 0 20 20">
    <rect width="20" height="20" rx="5" fill="rgba(34,197,94,0.15)" />
    <path
  ...
  return (
    <nav className="space-y-5">
      <h3
        ...
        style={{ ["--tw-after-bg" as string]: "#22c55e" }}
      >
        <span className="relative">
          {title}
          <span className="absolute -bottom-2 left-0 h-[2px] w-12 bg-[#22c55e]" />
        </span>
      </h3>
          ...
          <li key={link}>
            {link === "Contact" ? (
              <button
                ...
                className="inline-block transition-colors hover:text-[#22c55e]"
              >
                {link}
              </button>
