...
export const JOURNEY_STOPS = [
      ...
      },
      {
        ...
        description: "Turn Information into Revenue. Enabled by an AI-led process to create scalable data products for Direct Revenue, Operational Efficiency and Customer Experience.",
