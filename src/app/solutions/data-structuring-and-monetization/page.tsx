            ...
            <div className="flex flex-col gap-8 items-center">
              ...
              <div className="flex flex-col gap-6 items-start w-full">
                <div className="flex flex-col gap-5 items-center w-full">
                  <div className="flex justify-center">
                    <span className="border border-[#22c55e] rounded-md px-3 py-1.5 text-[18px] font-medium text-[#22c55e] bg-[#f0fdf4] capitalize">
                      Stage 1
                    </span>
                  </div>

                  <p className="text-center text-3xl font-medium leading-[38px] text-[#111827]">
                    The Foundation of Trust: Data Readiness
                  </p>

                  <p className="max-w-[860px] mx-auto text-center text-base font-normal leading-normal text-[#6b7280]">
                  ...
                  {[
                    {
                      ...
                      text: "We architect modern data environments (Data Lakes, Data Fabrics) and extract and unify siloed information across legacy systems, cloud, and third-party applications. Data is standardized and made instantly accessible across the enterprise.",
                    },
                    {
                      title: "Rigorous Cleansing & Validation",
                      text: "We enforce strict, automated data quality rules — identifying and removing anomalies, redundancies, and inaccuracies. AI models trained on this foundation operate with absolute accuracy. Leadership decisions built on absolute trust.",
                    },
                    {
                      title: "Semantic Enrichment",
                      text: "We prepare data for advanced ML with deep contextual layers. Standardizing internal taxonomies, securely connecting proprietary data to external enrichment sources, maximizing predictive power for every model trained on this foundation.",
                    },
                  ].map((c) => (
                    <div
                      key={c.title}
                      className="relative rounded-2xl border border-[#f3f4f6] bg-white p-5 shadow-sm hover:border-[#22c55e]/20 transition-colors"
                    >
                      <div className="flex flex-col gap-4 items-start">
                        <h3 className="capitalize text-2xl font-medium leading-[26px] text-[#111827]">
                          {c.title}
                        </h3>
              ...
              <div className="flex flex-col gap-6 items-start w-full">
                <div className="flex flex-col gap-5 items-center w-full">
                  ...
                  <p className="text-center text-3xl font-medium leading-[38px] text-[#111827] max-w-[860px]">
              ...
              <div className="flex flex-col gap-10 items-start w-full">
                <div className="flex flex-col gap-5 items-center w-full">
                  <h3 className="text-center text-3xl font-medium leading-[38px] text-[#111827]">
                    Data Monetization - From Problem to Profit.
                  </h3>
                  <p className="max-w-[860px] mx-auto text-center text-base font-normal leading-normal text-[#6b7280]">
                  ...
                  <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-stretch md:items-start min-h-[243px] relative">
                    <div className="flex-1 flex flex-col gap-4 items-start justify-start">
                      <div className="flex flex-col gap-2 w-full mb-2 h-[100px]">
                        <div className="bg-[#f9fafb] rounded-lg px-2.5 py-1.5 w-fit">
                          <span className="capitalize text-base font-medium text-[#111827]">
                            Business Challenge
                          </span>
                        </div>
                      ...
                      <div className="flex flex-col gap-2 w-full">
                        <div className="bg-[#f9fafb] rounded-lg px-2.5 py-2 w-fit">
                          <span className="capitalize text-base font-medium text-[#111827]">
                            Data Opportunity
                          </span>
                        </div>
