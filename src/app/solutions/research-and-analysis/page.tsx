...
export default function RAARPage() {
  ...
  {[
    ...
    <div key={item.title} className="h-full">
      <div
        className="h-full min-w-[220px] md:min-w-[220px] lg:min-w-[220px] xl:min-w-[250px] rounded-2xl border border-[#fcd5ac] bg-white/30 p-5 flex flex-col gap-4 items-start card-text-smaller"
      >
