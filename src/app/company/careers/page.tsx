        ...
        >
          <section className="relative px-6 py-5">
            <div className="max-w-5xl mx-auto text-center">
              <h2 className="text-4xl font-medium tracking-tight text-[#111827]">
                Join our Team
              </h2>
              <p className="mt-4 text-base text-[#6b7280] max-w-3xl mx-auto">
                Discover exciting and fulfilling opportunities at OphoTech, where challenges are met with collaboration and growth.
              </p>
            </div>
            ...
            <div className="relative mt-16 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-10 md:gap-16 items-start">
              ...
              <div className="flex flex-col items-center text-center">
                <div className="h-[60px] flex items-start justify-center">
                  <span className="inline-flex items-center justify-center rounded-lg border border-[#22c55e] px-4 py-1.5 text-base font-semibold text-[#22c55e]">
                    Senior Level
                  </span>
                </div>
                <h2 className="mt-4 text-3xl font-medium tracking-tight text-[#111827] h-[100px] flex items-start justify-center">
                  Business Development Manager
                </h2>
                <div className="mt-4 md:mt-2 lg:mt-0 mb-10 max-w-md text-[#6b7280] leading-relaxed">
                  <p
                    ref={leftTextRef}
                    className={[
                  ...
                  <div className="h-5">
                    {leftCanExpand ? (
                      <button
                        type="button"
                        className="text-sm font-medium text-[#22c55e] hover:text-[#16a34a] underline underline-offset-4"
                      ...
                      <span className="invisible text-sm font-medium underline underline-offset-4" aria-hidden>
                        Read more
                      </span>
                    )}
                  </div>
              ...
              <div className="hidden md:flex items-center justify-center self-start">
                <div className="w-px h-[320px] bg-gradient-to-b from-transparent via-[#22c55e]/30 to-transparent" aria-hidden />
              </div>
        ...
        >
          <section className="flex flex-col gap-10 items-center px-20 py-10 max-w-7xl mx-auto text-center">
            <div className="flex flex-col gap-5 items-center">
              <h2 className="text-4xl font-medium text-[#111827]">
                Life at OphoTech
              </h2>
              <p className="text-base text-[#6b7280] max-w-[860px]">
                At <span className="font-medium text-[#111827]">OphoTech</span>, we believe people do their best work when they&apos;re inspired, challenged, and supported. Our culture is built around <span className="font-medium text-[#111827]">curiosity, innovation, and collaboration</span> — with opportunities to grow at every step.
              </p>
            </div>
              ...
              {[{
                ...
                <Fragment key={item.title}>
                  <div className="flex flex-col gap-4 items-center w-full lg:w-[320px]">
                    ...
                    <h3 className="capitalize font-medium leading-normal text-xl text-[#111827] text-center">
                      {item.title}
                    </h3>
                    <p className="font-normal leading-normal text-sm text-[#6b7280] text-center">
                      {item.description}
                    </p>
                  </div>
                  ...
                  {index < array.length - 1 && (
                    <div className="hidden lg:flex items-center justify-center">
                      <div
                        className="w-px bg-gradient-to-b from-transparent via-[#22c55e]/30 to-transparent flex-shrink-0"
                        style={{ height: "400px" }}
                        aria-hidden
                      />
                    </div>
